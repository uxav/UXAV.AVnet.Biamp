...
using UXAV.AVnet.Biamp.Helpers;
using UXAV.Logging;
...
namespace UXAV.AVnet.Biamp.ControlBlocks
{
    public class DialerLine : TesiraChannelBase
    {
        ...
        public string LineLabel => _lineLabel;

        public uint LineNumber => ChannelNumber;
        ...
        public VoipCallStatusStateMap State
        {
            ...
            set
            {
                ...
                Logger.Debug("Line {0} State now {1} \"{2}\"", LineNumber, _state.Number, _state.Name);
        ...
        public VoipCallStatusPromptMap Prompt
        {
            ...
            set
            {
                ...
                Logger.Debug("Line {0} Prompt now {1} \"{2}\"", LineNumber, _prompt.Number, _prompt.Name);
        ...
        public DialerBlock DialerBlock => _dialerBlock;
        ...
        {
#if DEBUG
            Logger.Debug(ControlBlock.InstanceTag + " Line " + ChannelNumber,
        ...
        internal void UpdateCallStates(IEnumerable<CallState> callStates)
        {
            ...
            if (sData != null)
            {
                Logger.Debug("Line State for Line " + LineNumber,
